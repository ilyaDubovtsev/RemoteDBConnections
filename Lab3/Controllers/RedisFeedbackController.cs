...
namespace Lab3.Controllers
{
    ...
    {
        private readonly IRedisFeedbackRepository feedbackRepository;

        public RedisFeedbackController(IRedisFeedbackRepository redisFeedbackRepository)
        {
            this.feedbackRepository = redisFeedbackRepository;
        }
